...
router.get('/receipt-counter/active/:active_school_year_id', async (req, res) => {
    try {
...
router.put('/receipt-counter/:id', async (req, res) => {
    try {
        await ensureReceiptCounterAuditColumns();
        const { id } = req.params;
...
router.delete('/receipt-counter/:id', async (req, res) => {
    try {
        await ensureReceiptCounterAuditColumns();
        const { id } = req.params;
